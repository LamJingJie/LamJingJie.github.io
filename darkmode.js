...
//------------This section is used for android only----------------
// dark-mode media query matched or not
let matched = window.matchMedia('(prefers-color-scheme: dark)').matches;

function runOnLoad(){

  //check if its on android
  ...
  if(check === true){
    //executes for android only
    this.checkColorScheme();
    toggle_container?.classList.add("remove");
  }else{
    //The btn allowing user to change to darkmode at any moment (avail to web & ios only)
